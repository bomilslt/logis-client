...
const Sanitize = {
    ...
    /**
     * Nettoie un objet en échappant toutes les valeurs string
     */
    escapeObject(obj) {
        ...
        for (const [key, value] of Object.entries(obj)) {
            if (typeof value === 'string') {
                ...
                cleaned[key] = this.escapeObject(value);
            } else {
                cleaned[key] = value;
            }
        }
    ...
    sanitizeUrl(url) {
        ...
        try {
            ...
            if (url.toLowerCase().startsWith('javascript:') || 
                url.toLowerCase().startsWith('data:')) return null;
            return parsed.href;
        } catch { return null; }
    },
    ...
    /**
     * Template literal tag pour HTML sécurisé
     */
    html(strings, ...values) {
